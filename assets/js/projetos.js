      ...
      <div class="cards">
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/Pantern-Ship.gif"
              alt="gif do projeto de responsividade."
            />
            <div class="buttons">
              <a href="https://github.com/valm-dp/Pantern-Ship" target="_blank" title="Repositório no Github">
                <svg
              ...
              <a href="https://pantern-ship.netlify.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
        ...
        <div class="card">
          <h3>Brazilian Hands</h3>
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/BrazianHands.gif"
              alt="Imagem tema do projeto de desafio de código."
            />
            <div class="buttons">
              <a href="https://github.com/Henrique-Mourao/Brazilian-Hands" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://brazilianhaands.netlify.app/" id="desafio" title="Ver Projetos">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
            O Brazilian Hands foi um projeto da DNC para um cliente na Irlanda, apresentando uma cooperativa de brasileiros que oferecem serviços como limpeza, jardinagem e pintura.
          </p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/siteresponsivo.gif"
              alt="gif do projeto de responsividade."
            />
            <div class="buttons">
              <a href="https://github.com/Henrique-Mourao/RID183488_Desafio02" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://siteresposivo.netlify.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
          Desenvolvi este site demonstrando Gestão de Qualidade e Processos, com foco em otimização, eficiência e adaptação a diferentes dispositivos.
          </p>
          <p>HTML - CSS - MQs</p>
        </div>
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/responsi.gif"
              alt="gif do projeto de responsividade."
            />
            <div class="buttons">
              <a href="https://github.com/Henrique-Mourao/dnc-repov2" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://dnc-responsividade.netlify.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
            Landing page criada com foco na responsividade, que deve ser garantida por um site.
          </p>
          <p>HTML - CSS - MQs</p>
        </div>
        <div class="card">
